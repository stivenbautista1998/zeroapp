...
const TitleHeart = ({
  ...
  return (
    <svg className="icon icon-titleheart" xmlns="http:ww.w3.org/2000/svg" width={width} height={height} viewBox="0 0 32 32" aria-labelledby={iconTitle}>
...
const TitleEye = ({
  ...
  return (
    <svg className="icon icon-eye" xmlns="http:ww.w3.org/2000/svg" width={width} height={height} viewBox="0 0 32 32" aria-labelledby={iconTitle}>
